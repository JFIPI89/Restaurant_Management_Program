...
def guardar():
    ...
    try:
        ...
        if archivo:
            ...
            messagebox.showinfo('Informacion', 'Guardado cancelado.')
...
# lista de productos
lista_comidas = ['Pollo', 'coredero', 'Callos', 'Tacos', 'Gyro', 'pizza', 'Papas', 'Frijoles']
lista_bebidas = ['Agua', 'Vitaminwater', 'Vallefrut', 'Fanta', 'Vino', 'Tequila', 'Coca', 'Yoli']
lista_postres = ['Helado', 'Fruta', 'Brownies', 'Flan', 'Suspiros', 'Pastel', 'Pay', 'Crepas']
